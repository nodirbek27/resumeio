        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                v-if="activeTemplate === 'modern'"
                class="h-full grid grid-cols-12 text-slate-800 bg-white"
                style="font-family: 'Inter', sans-serif"
              >
                <!-- Sidebar -->
                <div
                  class="col-span-4 bg-slate-900 text-slate-100 p-6 flex flex-col justify-between h-full"
                >
                  <div>
                    <!-- Profile Photo -->
                  ...
                  <div
                    class="text-[10px] text-slate-600 text-center border-t border-slate-800 pt-3"
                  >
                    Modern Minimalist
                  </div>
                </div>
              ...
              <div
                v-else-if="activeTemplate === 'classic'"
                ...
                <div>
                  ...
                  <div class="text-center pb-4 border-b-2 border-slate-800 mb-6">
                    ...
                    >
                      <span v-if="formData.email"
                        ><q-icon name="mdi-email" /> {{ formData.email }}</span
                      >
                      <span v-if="formData.phone"
                        ><q-icon name="mdi-phone" /> {{ formData.phone }}</span
                      >
                      <span v-if="formData.address"
                        ><q-icon name="mdi-map-marker" /> {{ formData.address }}</span
                      >
                      <span v-if="formData.website"
                        ><q-icon name="mdi-web" /> {{ formData.website }}</span
                      >
                    </div>
                  </div>
                  ...
                  <div class="mb-6">
                    ...
                    <div class="space-y-4">
                      <div v-for="(exp, idx) in formData.experience" :key="idx" class="text-xs">
                        <div class="flex justify-between items-baseline font-sans">
                          <div class="flex gap-2">
                            <strong class="text-slate-900 text-sm font-serif">{{
                              exp.position
                            }}</strong>
                      ...
                      <p
                        v-if="formData.experience.length === 0"
                        class="text-xs text-slate-400 italic font-sans"
                      >
                        No experience added
                      </p>
                    </div>
              ...
              <div
                v-else-if="activeTemplate === 'creative'"
                  ...
                  >
                    <div class="flex justify-between items-start gap-4">
                      <div>
                        ...
                        <p
                          class="text-xs font-semibold text-indigo-200 uppercase tracking-widest mt-1"
                        >
                          {{ formData.title || 'Job Title' }}
                        </p>
                  ...
                  <div class="p-6 grid grid-cols-12 gap-6">
                    ...
                    <div class="col-span-8 space-y-5">
                      ...
                      <div v-if="formData.summary">
                        <h3
                          class="text-xs font-extrabold uppercase tracking-widest text-indigo-800 mb-2"
                        >
                          Profile
                        </h3>
                      ...
                      <div>
                        ...
                        <div class="space-y-4">
                          <div
                            v-for="(exp, idx) in formData.experience"
                            :key="idx"
                            class="text-xs relative pl-4 border-l-2 border-indigo-100"
                          >
                            <!-- Bullet dot -->
                            <span
                              class="w-2 h-2 rounded-full bg-indigo-600 absolute -left-[5px] top-1"
                            ></span>
                    ...
                    <div class="col-span-4 space-y-5">
                      ...
                      <div>
                        ...
                        <div class="space-y-3">
                          <div
                            v-for="(edu, idx) in formData.education"
                            :key="idx"
                            class="text-[11px]"
                          >
              ...
              <div
                v-else-if="activeTemplate === 'minimal'"
              ...
              >
                <div>
                  <div
                    ...
                    :style="{ borderBottom: '2px solid ' + formData.accentColor }"
                  >
                    <img
                      v-if="formData.photo"
                      :src="formData.photo"
                  ...
                  <div
                    class="flex flex-wrap gap-x-4 gap-y-1 text-[10px] text-slate-500 mb-6 font-mono"
                  >
                    <span v-if="formData.email"
                      ><q-icon name="mdi-email" size="12px" /> {{ formData.email }}</span
                    >
                    <span v-if="formData.phone"
                      ><q-icon name="mdi-phone" size="12px" /> {{ formData.phone }}</span
                    >
                    <span v-if="formData.address"
                      ><q-icon name="mdi-map-marker" size="12px" /> {{ formData.address }}</span
                    >
                    <span v-if="formData.website"
                      ><q-icon name="mdi-web" size="12px" /> {{ formData.website }}</span
                    >
                  </div>

                  <p v-if="formData.summary" class="text-xs text-slate-600 leading-relaxed mb-6">
                    {{ formData.summary }}
                  </p>
                  ...
                  <div class="mb-6">
                    ...
                    <div class="space-y-3">
                      <div v-for="(exp, idx) in formData.experience" :key="idx" class="text-xs">
                        ...
                        <p
                          class="text-slate-500 text-[11px] mt-0.5 leading-relaxed whitespace-pre-wrap"
                        >
                          {{ exp.description }}
                        </p>
                      </div>
                ...
                <div class="col-span-8 p-8 flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p
                      ...
                      class="text-xs text-slate-600 leading-relaxed italic mt-4 mb-6"
                    >
                      {{ formData.summary }}
                    </p>
